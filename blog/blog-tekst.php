...
if(!empty($_GET['h'])) {
	...
	if($num > 0) {
		...
		show_msg('<h1>Post not found</h1>', '<a href="blog-izborna.php">Go home</a>');
	}
}else {
	header("location: blog-izborna.php");
}
?>
<!DOCTYPE html>
...
<head>
	...
	echo '<meta property="og:description" content="'.$preview.'">';
	echo '<meta name="twitter:title" content="'.$headline.'">';
	echo '<meta name="twitter:description" content="'.$preview.'">';
	echo '<meta name="twitter:image:src" content="'.$image.'">';
	echo '<meta itemprop="name" content="'.$headline.'">';
	echo '<meta itemprop="description" content="'.$preview.'">';
	echo '<meta itemprop="image" content="'.$image.'">';
	echo '<meta name="author" content="'.$author.'">';
	echo '<meta name="keywords" content="'.$tags.'">';
	echo '<meta name="description" content="'.$preview.'">';
	?>
	<!-- Meta -->
	<meta charset="utf-8">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="home.html">Option 14: Home Magazine</a></li>
								<li class="dropdown-submenu">
		...
		<div class="container content">
			<div class="row blog-page">
				...
				<div class="col-md-9 md-margin-bottom-40">
					...
					echo '<div class="blog-grid margin-bottom-30">';
					echo '<h2 class="blog-grid-title-lg">'.$headline.'</h2>';
					echo '<div class="overflow-h margin-bottom-10">';
					echo '<ul class="blog-grid-info pull-left">';
					echo '<li>'.$author.'</li>';
					echo '<li>'.$date.'</li>';
					echo '<li><a href="blog-izborna.php?c='.$category.'">'.$category.'</a></li>';
					echo '</ul>';
					...
					if($tags != "No tags") {
						...
						while(strpos($tags, ",") !== false) {
							...
							echo '<a href="blog-izborna.php?t='.$tag.'" class="btn-u btn-u-emerald">'.$tag.'</a> ';

							$tags = str_replace($tag."," , "", $tags);
						}

						echo '<a href="blog-izborna.php?t='.$tags.'" class="btn-u btn-u-emerald">'.$tags.'</a>';
						echo '</p>';
					}
					?>
					<br>
					...
					if(!empty($_SESSION['id'])) {
						echo '<h2 class="title-v4">Postavi Komentar</h2>';
						echo '<form action="comment.php" method="post" id="sky-form3" class="sky-form comment-style-v2">';
						echo '<input type="hidden" name="url" value="'.$url.'">';
						echo '<fieldset>';
						echo '<div class="row sky-space-30">';
						echo '<div class="col-md-6">';
						echo '</div>';
						echo '</div>';
						echo '<div class="sky-space-30">';
						echo '<div>';
						echo '<textarea rows="8" name="comment" form="comment" id="message" placeholder="Write comment here ..." class="form-control bg-color-light"></textarea><br>';
						echo '</div>';
						echo '</div>';
						echo '<p><button type="submit" class="btn-u btn-u-default">Submit</button></p>';
						echo '</fieldset>';
						echo '<div class="message">';
						echo '<i class="rounded-x fa fa-check"></i>';
						echo '<p>Your comment was successfully posted!</p>';
						echo '</div>';
						echo '</form>';
					}else {
					...
					echo '<h2 class="title-v4">Komentari '.$total.'</h2>';
					...
					if($total > 0) {
						while($row = mysqli_fetch_array($rows)) {
							...
							echo '<div class="row blog-comments-v2">';
							echo '<div class="comments-itself">';
							echo '<h4>'.$author.'</h4>';
							echo '<p>'.$comment.'</p>';
							echo '</div>';
							echo '</div>';
				...
				<div class="col-md-3">
					...
					<div class="posts margin-bottom-40">
						<div class="headline headline-md"><h2>Tekstovi</h2></div>
						<?php
